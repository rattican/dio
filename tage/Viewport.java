...
/**
 * Viewport contains its own camera to display a different view of the scene. A2 uses this to create an Overhead of the game to act like a birds' eye view of the overworld.
 * 
 * Modified Viewport for CSC 165 A2 by Emily Kuang
 * <p>
 * Additions:
 * <ul>
 * <li>Added private String name</li>
 * <li>Added getter method for String name</li>
 * <li>Modified constructor to take String name</li>
 * <li>Added setCamera function</li>
 * </ul>
 * 
 * <p>Original Viewport implementation by Dr. Scott Gordon</p>
